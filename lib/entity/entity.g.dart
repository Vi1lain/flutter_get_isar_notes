...
extension NoteQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
  QueryBuilder<Note, Note, QAfterSortBy> sortByCheck() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'check', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortByCheckDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
  QueryBuilder<Note, Note, QAfterSortBy> thenByCheck() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'check', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenByCheckDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'check', Sort.desc);
    });
  }
...
extension NoteQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
  QueryBuilder<Note, Note, QDistinct> distinctByCheck() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, bool, QQueryOperations> checkProperty() {
    return QueryBuilder.apply(this, (query) {
